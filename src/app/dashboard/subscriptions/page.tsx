...
export default async function Subscriptions() {
  ...
  return (
    <>
      ...
      <main className="max-w-7xl mx-auto my-20 space-y-5 container flex flex-col items-center md:flex-row md:items-start md:justify-center md:gap-x-20 lg:gap-x-40 px-4 md:px-8">
