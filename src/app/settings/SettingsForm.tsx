...
export default function FormSetting({ user }: FormSettingProps) {
  return (
    <>
      <main>
        <Tabs>
          <div className="flex items-start">
            <div className="px-10 min-w-72">
              <TabList className={"flex"}>
                <Tab className={"px-2 py-1 bg-white/30 border-white/10"}>
                  Title 1
                </Tab>
                <Tab className={"px-2 py-1 bg-white/30 border-white/10"}>
                  Title 2
            ...
            <div className="flex-1 flex flex-col">
              <h1>Settings</h1>
              <form>
                <div className="space-y-12 lg:mr-10">
                  <TabPanel>
