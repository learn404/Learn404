...
Déjà, la programmation asynchrone est une technique qui permet à un programme de démarrer une tâche potentiellement longue et, au lieu d'attendre la fin de cette tâche, de continuer à réagir aux autres événements pendant son exécution. Une fois la tâche terminée, le programme reçoit le résultat.
