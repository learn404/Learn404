    ...
    <div className="mx-auto max-w-[960px] py-[50px] flex items-center justify-center flex-col gap-20 text-center">
      <div className="flex flex-col items-center justify-center gap-7">
        ...
        <div className="flex flex-col items-center justify-center gap-6" >
          <h1 className="inline-block font-semibold text-7xl font- text-center titleStyle">La banque de ressources qu'il te manque</h1>
          <span className="text-torea-50">Améliore tes compétences en pratiquant !</span>
        </div>
        <div className="flex items-center justify-center gap-4">
          <PrimaryButton redirectTo="/waitlist" type="button">
            <span className="hidden md:block font-medium">Rejoindre l'aventure</span>
          </PrimaryButton>
          <SecondaryButton redirectTo="/" type="button">
            <span className="hidden md:block font-medium">Besoin d'en savoir plus ?</span>
          </SecondaryButton>
        </div>
      </div>
